...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.ngOnInit = function () {
        ...
        this.homeService.nyokot()
            ...
            _this.dataRaw = data;
            console.log(_this.dataRaw.data);
    ...
    HomeComponent.prototype.LihatKota = function (params) {
        var ros = this.router.navigate(['mapdetail/', params]);
        console.log(params);
    };
...
var MapdetailComponent = /** @class */ (function () {
    ...
    MapdetailComponent.prototype.detailKota = function (params) {
        var _this = this;
        console.log(params);
